...
%changelog
* Mon May 11 2015 Masahiro Nakagawa <masa@treasure-data.com>
- v1.1.22
- ruby v1.9.3-p551
- fluentd v0.10.61
- td-client v0.8.68
...
- Fix fluentd shutdown without killproc

* Tue Apr 1 2014 Masahiro Nakagawa <masa@treasure-data.com>
- v1.1.19
- fluentd v0.10.45
- td-client v0.8.58
- td v0.10.99
